    ...
    <section id="home-page">
        ...
        <section id="home">
            ...
            <div id="home-content">
                ...
                <a class="btn btn-general btn-home" href="#" title="Learn More" role="button">LEARN MORE</a>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-4 col-12 text-right">
                            <ul class="social-list">
                                <li><a class="facebook-img" href="#"><img src="../images/Homepage/facebook.png" alt=""></a>
                                </li>
                                <li><a class="twitter-img" href="#"><img src="../images/Homepage/twitter.png" alt=""></a>
                                </li>
                                <li><a class="linkedin-img" href="#"><img src="../images/Homepage/linkedin.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
