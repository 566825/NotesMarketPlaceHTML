            ...
            <div class="content-box-lg">
                ...
                <div class="container">
                    ...
                    if (isset($_SESSION['UserID'])) {
                        ...
                        $_SESSION['readonlyField'] = "readonly";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo empty($FullName) ? "" : $FullName; ?>" name="FullName" type="text" class="form-control input-box-style" placeholder="Enter your full name" <?php if (isset($_SESSION['readonlyField'])) {
                                                                                                                                                                                                            echo $_SESSION['readonlyField'];
                                                                                                                                                                                                        } ?> required>
                                </div>

                                <div class="form-group">
                                    <label class="info-label" for="">Email Address *</label>
                                    <input value="<?php echo empty($EmailID) ? "" : $EmailID; ?>" name="EmailID" type="email" class="form-control input-box-style" placeholder="Enter your email address" <?php if (isset($_SESSION['readonlyField'])) {
                                                                                                                                                                                                                echo $_SESSION['readonlyField'];
                                                                                                                                                                                                            } ?> required>
                                </div>
