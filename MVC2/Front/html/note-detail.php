                                ...
                                <div class="note-desc-box">
                                    ...
                                    if (isset($_POST['FreeNoteButton'])) {
                                        if ($check_downloads_count == 0) {
                                            $insert_download = "INSERT INTO downloads (NoteID, Seller, Downloader, IsSellerHasAllowedDownload, IsAttachmentDownloaded, AttachmentDownloadedDate, IsPaid, NoteTitle, NoteCategory, CreatedBy) ";
                                            $insert_download .= "VALUES ({$NoteID}, {$NoteSellerID}, {$UserID}, 1, 1, now(), 0, '{$NoteTitle}', '{$NoteCategory}', {$UserID}) ";
